    ...
    public partial class Form1 : Form
    {
        ...
        private void EnemyPlayTimerEvent(object sender, EventArgs e)
        {
            ...
            if (round < 1 || enemyScore > 2 || playerScore > 2)      
            {
                ...
                {
                    SoundPlayer splayer = new SoundPlayer(@"\\JLC-FSRV01\s24000007739\Downloads\battleship-game-project-main\battleship-game-project-main\battleship-game-project-main\battleship game\bin\Debug\winsoundforprogram.wav");
                    splayer.Play();
                    MessageBox.Show("You win");
                    

                    //https://www.youtube.com/watch?v=ddmUo3YMfzg thats the tutorial i used for this
                    Restartthedamngame();
                ...
                {
                    SoundPlayer splayer = new SoundPlayer(@"\\JLC-FSRV01\s24000007739\Downloads\battleship-game-project-main\battleship-game-project-main\battleship-game-project-main\battleship game\bin\Debug\losingsoundforprogram.wav");
                    splayer.Play();
                    MessageBox.Show("your ship has bee sunken yikes");
                        Restartthedamngame();
                }
                else if (enemyScore == playerScore)
                {
